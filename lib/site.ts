...
export const ROUTES: { path: string; priority: number }[] = [
  ...
  { path: "/convention/register", priority: 0.8 },
  { path: "/convention/schedule", priority: 0.7 },
  { path: "/convention/plan-your-visit", priority: 0.6 },
  { path: "/convention/business-group", priority: 0.5 },
  { path: "/convention/cacma", priority: 0.5 },
  { path: "/convention/children", priority: 0.5 },
  { path: "/convention/christian-education", priority: 0.5 },
  { path: "/convention/good-women", priority: 0.5 },
  { path: "/convention/ministers-wives", priority: 0.5 },
  { path: "/convention/youth", priority: 0.5 },
  { path: "/convention/gallery", priority: 0.5 },
  { path: "/convention/archive", priority: 0.5 },
  { path: "/convention/live", priority: 0.5 },
  { path: "/convention/news", priority: 0.5 },
  { path: "/convention/give", priority: 0.4 },
  { path: "/convention/contact", priority: 0.5 },
  { path: "/convention/about", priority: 0.6 },
];
