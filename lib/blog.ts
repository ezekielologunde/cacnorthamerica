...
export const POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    readTime: "6 min read",
    body: [
      "\"Now that you have purified yourselves by obeying the truth so that you have sincere love for each other, love one another deeply, from the heart\" (1 Peter 1:22-25, NIV). From this text, Ministers' Session 1 — **\"Transformative Power of the Word\"** — opened this year's convention with a question every believer eventually has to sit with: what does it actually mean to obey the truth?",
  ...
  },
  {
    ...
    body: [
      ...
      "He walked through biblical figures who faced real hardship and were not exempt from it because of their faithfulness: Adam, misled into disobedience; Noah, who stumbled even after being spared the flood; and Abraham, barren well into old age. Yet Scripture is also, he said, God's own instrument of encouragement — giving hope grounded in God's promises even in hopeless situations (Romans 15:4, Jeremiah 29:11, Psalm 42:11), and reminding believers that God never abandons His people (Isaiah 41:10, Joshua 1:9, Matthew 28:20).",
