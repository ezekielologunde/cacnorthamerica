...
export const POSTS: BlogPost[] = [
  {
    ...
    dateIso: "2026-07-04",
    category: "Devotional",
    categoryColor: "#3D5FA1",
    accent: "linear-gradient(135deg,#3D5FA1,#1E3A6B)",
    readTime: "2 min read",
    body: [
  ...
  },
  {
    ...
    accent: "linear-gradient(135deg,#E8A33D,#3D5FA1)",
    readTime: "4 min read",
  ...
  },
  {
    ...
    dateIso: "2026-05-25",
    category: "Reflection",
    categoryColor: "#0F1F3D",
    accent: "linear-gradient(135deg,#0F1F3D,#1E3A6B)",
    readTime: "4 min read",
    body: [
