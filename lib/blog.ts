...
export const POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt:
      "On Matthew 11:28-29 — recognizing physical exhaustion in ministry leadership, and practical steps to prevent burnout while remaining present and available to serve.",
    date: "July 2025",
    dateIso: "2025-07-01",
    category: "Reflection",
    categoryColor: "#7A1128",
    ...
    readTime: "4 min read",
    body: [
      "\"Physical exhaustion comes as a result of a lack of rest and self-care in the name of service,\" begins this reflection from the Christ Apostolic Church Hope For All newsletter, on Matthew 11:28-29. \"Jesus Christ, in His love and care, called out with an invitation. He knows and sees everything. He sympathizes and empathizes, hence His invitation, and He proffers solution to our struggles: 'Come to Me and take My yoke upon you.' We are invited to come over with our weariness. His desire is to partner and share the load with us.\"",
      "\"In this process, we are going to learn from Him and adopt His gentle and humble attitude of leadership style. He does not promise us a life free from responsibility pressure, but He offers ways and means to engage meaningfully in the ministry. Shared burden is a path to relieve and rest — let's take His proffered advice by taking His yoke and shared load. He's always there to help. Wherever we are as leaders, whether in the ministry or business, Jesus Christ sees and knows where we are hurting. He'll help with our weakness and human frailty and share in the burden.\"",
      "Some practical steps to prevent burnout: have a regular time with God in prayer, combining it with Bible study and worship; set time daily to end work and rest, and have fellowship with family; create time to fellowship with colleagues, counselors, and mentors for guidance and encouragement; and refresh the spirit, rejuvenate, and engage in hobbies in a structured way. \"All work and no play makes for a full boy, and it is a necessary application to avoid burnout.\"",
      "\"I conclude with this question: what must we do to avoid burnout? Leadership, as sacred as it is, if handled in the way our Lord Jesus advised, will be less stressful and weary-free. We'll see that it is both beneficial and essential. Let's lead from the perspective of rest, modeling the very peace we proclaim. I pray that we all embrace the rest our Lord Jesus graciously proffers. Thank you, and remember that His second coming is very close. Please remain rapturable with holy and obedient living.\"",
    ],
  },
  {
