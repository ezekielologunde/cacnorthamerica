...
<body style="margin:0;padding:0;background:#F9F8F6;font-family:Georgia,serif">
  <div style="max-width:600px;margin:40px auto;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(16,22,29,.10)">
    <div style="background:#10161D;padding:36px 40px;text-align:center">
      <p style="margin:0 0 10px;font-size:12px;font-weight:700;letter-spacing:2.5px;text-transform:uppercase;color:rgba(244,246,248,.45)">CACNA</p>
    ...
    <div style="padding:40px">
      ...
      <p style="font-size:16px;color:#10161D;line-height:1.75;margin:0 0 18px">
      ...
      <div style="background:#F9F8F6;border-radius:12px;padding:24px;margin-bottom:32px">
        ...
        <p style="font-size:14px;color:#10161D;line-height:1.8;margin:0">
      ...
      <p style="font-size:12px;color:rgba(16,22,29,.4);line-height:1.7;margin:0">
