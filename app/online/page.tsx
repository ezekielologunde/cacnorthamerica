  ...
  return (
    <main style={{ background: "#0C0E13", minHeight: "100vh" }}>
      ...
      <section style={{ padding: "140px clamp(20px,5vw,64px) 80px", position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", top: -80, right: -80, width: 400, height: 400, borderRadius: "50%", background: "radial-gradient(circle,rgba(214,41,58,.25),transparent 70%)", pointerEvents: "none" }} />
      ...
      <section style={{ padding: "0 clamp(20px,5vw,64px) 56px" }}>
        <Reveal>
          <a href={YOUTUBE_URL} target="_blank" rel="noopener noreferrer" className="btn-sheen card-lift" style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: "clamp(20px,3vw,40px)", maxWidth: 900, margin: "0 auto", background: "linear-gradient(120deg,#D6293A,#7A1420)", borderRadius: 28, padding: "clamp(28px,4vw,44px)", textDecoration: "none", boxShadow: "0 30px 70px rgba(214,41,58,.35)" }}>
            ...
            <span style={{ flexShrink: 0, display: "inline-flex", alignItems: "center", gap: 8, background: "#fff", color: "#7A1420", fontWeight: 800, fontSize: 16, padding: "15px 28px", borderRadius: 999 }}>
              Open YouTube →
            </span>
          </a>
        </Reveal>
      ...
      {/* Salvation CTA */}
      <section style={{ padding: "80px clamp(20px,5vw,64px)", background: "linear-gradient(135deg,#D6293A,#7A1420)" }}>
