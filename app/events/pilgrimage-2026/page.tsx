  ...
  return (
    <main>
      ...
      <section style={{ background: "var(--ink)", padding: "150px clamp(20px,5vw,64px) clamp(80px,10vw,120px)", position: "relative", overflow: "hidden" }}>
        ...
        <div aria-hidden style={{ position: "absolute", bottom: -60, left: -60, width: 480, height: 380, background: "radial-gradient(circle,rgba(30,58,107,.12),transparent 65%)", pointerEvents: "none" }} />
        ...
        <div style={{ maxWidth: 960, margin: "0 auto", position: "relative", zIndex: 2 }}>
          ...
          <h1 style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: "clamp(40px,6.5vw,90px)", letterSpacing: "-0.035em", color: "#fff", margin: "0 0 24px", lineHeight: 0.92, textWrap: "balance" }}>
            ...
            <br />
            <RevealText immediate delay={0.12} style={{ background: "linear-gradient(100deg,#E8A33D,#3D5FA1,#1E3A6B)", WebkitBackgroundClip: "text", backgroundClip: "text", WebkitTextFillColor: "transparent" }}>
              Pilgrimage 2026
            </RevealText>
          </h1>
