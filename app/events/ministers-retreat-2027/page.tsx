...
export default function MinistersRetreat2027Page() {
  ...
  return (
    <main>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Events", path: "/events" }, { name: ev.navLabel ?? ev.title, path: "/events/ministers-retreat-2027" }])).replace(/</g, "\\u003c") }} />
      <Nav heroDark />
      {isPast && (
