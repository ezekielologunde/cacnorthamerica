  ...
  return (
    <main>
      ...
      >
        ...
        <div aria-hidden style={{ position: "absolute", bottom: -80, left: -60, width: 380, height: 380, background: "radial-gradient(circle,rgba(245,246,250,.05),transparent 65%)", pointerEvents: "none" }} />
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))", gap: "clamp(48px,6vw,80px)", alignItems: "center" }}>
          <div>
            <Reveal>
              <span style={{ fontSize: 12, fontWeight: 800, letterSpacing: "2.5px", textTransform: "uppercase", color: "rgba(245,246,250,.6)" }}>
            ...
            <Reveal delay={300}>
              <p style={{ fontSize: "clamp(16px,1.8vw,19px)", color: "rgba(245,246,250,.78)", lineHeight: 1.7, maxWidth: 500, margin: "0 0 36px", textWrap: "pretty" }}>
        ...
        <div style={{ maxWidth: 720, margin: "0 auto", textAlign: "center" }}>
          <Reveal>
            <blockquote cite="https://www.biblegateway.com/passage/?search=Acts+16%3A9&version=NIV" style={{ margin: 0 }}>
              <p style={{ fontFamily: "var(--font-display)", fontSize: "clamp(20px,2.8vw,30px)", fontWeight: 700, fontStyle: "italic", color: "rgba(245,246,250,.9)", lineHeight: 1.5, letterSpacing: "-.3px", margin: "0 0 14px" }}>
                "Come over to Macedonia and help us."
              </p>
              <footer style={{ fontSize: 12, fontWeight: 800, letterSpacing: "2px", textTransform: "uppercase", color: "rgba(245,246,250,.4)" }}>
          ...
          <div style={{ display: "grid", gap: 16 }}>
            {PILLARS.map(({ icon: Icon, label, desc }, i) => (
              <Reveal key={label} delay={200 + i * 80}>
                <div style={{ display: "flex", gap: 18, background: "var(--paper)", borderRadius: 20, padding: "22px 24px", border: "1px solid var(--line)", boxShadow: "0 8px 22px rgba(18,20,30,.05)" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(260px,1fr))", gap: 20 }}>
            {WAYS.map(({ num, label, desc, cta, href }, i) => (
              <Reveal key={num} delay={i * 90}>
                <div style={{ height: "100%", background: "var(--paper)", border: "1px solid var(--line)", borderRadius: 24, padding: "32px 28px", boxShadow: "0 12px 32px rgba(18,20,30,.06)", display: "flex", flexDirection: "column" }}>
      ...
      >
        ...
        <div style={{ maxWidth: 660, margin: "0 auto", position: "relative", zIndex: 2 }}>
          <Reveal>
            ...
            <p style={{ fontSize: "clamp(15px,1.7vw,18px)", color: "rgba(245,246,250,.74)", lineHeight: 1.7, margin: "0 0 36px", textWrap: "pretty" }}>
