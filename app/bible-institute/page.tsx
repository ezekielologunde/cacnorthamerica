...
const gradients = [
  ...
  "linear-gradient(135deg,#7A1128,#2D42C9)",
];
...
export default async function BibleInstitutePage() {
  ...
  return (
    <main>
      ...
      <section style={{ background: "var(--ink)", padding: "clamp(64px,8vw,100px) clamp(20px,5vw,64px)", textAlign: "center" }}>
        <Reveal>
          <GraduationCap size={40} strokeWidth={1.5} color="var(--gold)" aria-hidden style={{ marginBottom: 20 }} />
          <h2 style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: "clamp(26px,3.5vw,42px)", letterSpacing: "-1px", color: "#fff", margin: "0 0 14px", lineHeight: 1.05 }}>
            Programs & admissions — coming soon.
          </h2>
          <p style={{ fontSize: 16, color: "rgba(245,246,250,.65)", lineHeight: 1.7, maxWidth: 560, margin: "0 auto" }}>
            Course offerings and how to apply will be published here as they're finalized. For now, reach out through our{" "}
