  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f0ede8;padding:40px 16px">
    <tr><td align="center">
      <table width="100%" style="max-width:580px;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(27,19,14,.1)">
        ...
        <tr>
          <td style="padding:28px 32px 0">
            <div style="font-size:12px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;color:#178055;margin-bottom:16px">What happens next</div>
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td style="padding:12px 0;border-bottom:1px solid #ede9e4;vertical-align:top;width:28px">
                  <div style="width:24px;height:24px;background:#f9f8f6;border-radius:50%;font-size:12px;font-weight:700;color:#178055;text-align:center;line-height:24px">1</div>
                </td>
              ...
              <tr>
                <td style="padding:12px 0;vertical-align:top;width:28px">
                  <div style="width:24px;height:24px;background:#f9f8f6;border-radius:50%;font-size:12px;font-weight:700;color:#178055;text-align:center;line-height:24px">2</div>
                </td>
        ...
        <tr>
          <td style="padding:28px 32px;border-top:1px solid #ede9e4;margin-top:28px">
            ...
            <p style="margin:12px 0 0;font-size:12px;color:#aaa">
              <a href="https://cacnorthamerica.com" style="color:#178055;text-decoration:none;font-weight:700">cacnorthamerica.com</a>
...
<tr><td style="padding:24px 28px">
  ...
  <table cellpadding="0" cellspacing="0" style="font-size:13px;color:#1B130E;line-height:1.7">
    ...
    <tr><td style="padding-right:12px;color:#5f5e5a">Email</td><td><a href="mailto:${email}" style="color:#178055">${email}</a></td></tr>
  ...
  ${shippingBlock}
  <div style="margin-top:24px"><a href="https://www.cacnorthamerica.com/admin/orders" style="display:inline-block;background:#178055;color:#fff;font-size:13px;font-weight:700;text-decoration:none;padding:10px 20px;border-radius:8px">View in Admin</a></div>
</td></tr>
<tr><td style="padding:16px 28px;border-top:1px solid #ede9e4">
  <p style="margin:0;font-size:12px;color:#aaa"><a href="https://cacnorthamerica.com" style="color:#178055;text-decoration:none;font-weight:700">cacnorthamerica.com</a> &nbsp;·&nbsp; Blue Ridge Summit, Pennsylvania</p>
</td></tr>
...
<tr><td style="padding:28px 32px">
  ...
  <div style="margin-top:24px;background:#f9f8f6;border-radius:10px;padding:16px 20px">
    <p style="font-size:13px;color:#5f5e5a;margin:0;line-height:1.7">
      ...
      <a href="https://wa.me/14432726794" style="color:#25D366;font-weight:700;text-decoration:none">+1 (443) 272-6794</a>
      or email <a href="mailto:info@cacnorthamerica.com" style="color:#178055;text-decoration:none">info@cacnorthamerica.com</a>.
    </p>
  </div>
</td></tr>
...
<tr><td style="padding:24px 28px;font-size:13px;color:#1B130E;line-height:1.8">
  <table cellpadding="0" cellspacing="0">
    ...
    ${customerEmail ? `<tr><td style="padding-right:12px;color:#5f5e5a">Email</td><td><a href="mailto:${customerEmail}" style="color:#178055">${customerEmail}</a></td></tr>` : ""}
  ...
  <div style="margin-top:20px"><a href="https://www.cacnorthamerica.com/admin/orders" style="display:inline-block;background:#178055;color:#fff;font-size:13px;font-weight:700;text-decoration:none;padding:10px 20px;border-radius:8px">View in Admin</a></div>
</td></tr>
</table></td></tr></table></body></html>`;
