...
const children = [
  {
    ...
    accent: "linear-gradient(140deg,#1D5FBF,#D6293A)",
  },
  {
    ...
    accent: "linear-gradient(140deg,#E8A33D,#1D5FBF)",
  },
];
...
export default function DevotionalPage() {
  return (
    <main>
      ...
      {/* 2026 Watchword */}
      <section style={{ background: "linear-gradient(135deg,#7A1420,#D6293A)", padding: "clamp(56px,7vw,90px) clamp(20px,5vw,64px)", position: "relative", overflow: "hidden" }}>
