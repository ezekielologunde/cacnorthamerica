  ...
  return (
    <main>
      ...
      <section style={{
        ...
        <div aria-hidden style={{ position: "absolute", bottom: -60, left: -80, width: 400, height: 340, background: "radial-gradient(circle,rgba(214,41,58,.14),transparent 65%)", pointerEvents: "none" }} />
