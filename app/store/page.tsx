  ...
  return (
    <main>
      ...
      <section style={{
        ...
        <div aria-hidden style={{ position: "absolute", bottom: -60, left: -80, width: 400, height: 340, background: "radial-gradient(circle,rgba(31,77,61,.14),transparent 65%)", pointerEvents: "none" }} />
