      ...
      <div style={{ padding: "28px 32px 32px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
          ...
          <Link href={`/blog/${post.slug}`} className="press" style={{
            ...
            boxShadow: "0 8px 20px rgba(31,77,61,.3)",
          }}>
...
function StoreAdWidget() {
  return (
    <aside style={{
      background: "linear-gradient(140deg,#12302A,#1F4D3D)",
      ...
      <section style={{ background: "var(--cream)", padding: "0 clamp(20px,5vw,64px) clamp(56px,7vw,90px)" }}>
        <Reveal>
          <div style={{
            ...
            background: "linear-gradient(135deg,#12302A,#1F4D3D)",
            borderRadius: 28, padding: "clamp(28px,4vw,44px)",
            display: "flex", flexWrap: "wrap", alignItems: "center",
            justifyContent: "space-between", gap: 24,
            boxShadow: "0 24px 60px rgba(31,77,61,.28)",
