...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    dropdown: [
      { href: conventionCtaHref, label: 'Register', desc: nextConvention.registrationUrl ? 'Secure your spot' : 'Details announced soon', external: isExternalHref(conventionCtaHref) },
      { href: '/convention/schedule', label: 'Schedule', desc: 'Day-by-day agenda' },
      { href: '/convention/plan-your-visit', label: 'Plan Your Visit', desc: 'Hotels, travel & etiquette' },
      { href: '/convention/business-group', label: 'Business Group', desc: 'Fellowship for the business-minded' },
      { href: '/convention/cacma', label: 'CACMA', desc: "Men's Association" },
      { href: '/convention/children', label: "Children's Convention", desc: 'Programming for kids' },
      { href: '/convention/christian-education', label: 'Christian Education', desc: 'Sunday School department' },
      { href: '/convention/good-women', label: 'Good Women', desc: 'Good Women Association' },
      { href: '/convention/ministers-wives', label: "Ministers' Wives", desc: 'Fellowship for ministers\' wives' },
      { href: '/convention/youth', label: 'Youth & Young Adult', desc: 'Youth programming' },
      { href: '/convention/gallery', label: 'Gallery', desc: 'Photos from past conventions' },
      { href: '/convention/archive', label: 'Archive', desc: 'Past themes & dates' },
      { href: '/convention/live', label: 'Live', desc: 'Watch the convention live' },
      { href: '/convention/news', label: 'News', desc: 'Convention news & events' },
      { href: '/convention/give', label: 'Give', desc: 'Support the convention' },
      { href: '/convention/contact', label: 'Contact', desc: 'Committee contacts' },
      { href: '/convention/about', label: 'About', desc: 'Story, mission & leadership' },
    ],
  },
