...
const dateBg = [
  'linear-gradient(150deg,#2D42C9,#1D2B83)',
  'linear-gradient(150deg,#F0742F,#2D42C9)',
  'var(--ink)',
];
      ...
      <div style={{ maxWidth: 1240, margin: '0 auto' }}>
        ...
        {upcoming.length === 0 ? (
          ...
          <div className="r2" style={{ gap: 22 }}>
            {upcoming.map((ev, i) => (
              <Reveal key={ev.id} delay={i * 120} style={{ display: 'flex', gap: 20, alignItems: 'flex-start', background: 'var(--paper)', borderRadius: 24, padding: 28, boxShadow: '0 10px 26px rgba(18,20,30,.06)' }}>
                <div style={{
