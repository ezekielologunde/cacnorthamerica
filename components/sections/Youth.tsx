        ...
        <div className="r3" style={{ gap: 22 }}>
          ...
          <Reveal delay={100}>
            <Link
              href="/bible-plan"
              className="card-lift"
              style={{ textDecoration: 'none', color: 'inherit', background: 'var(--paper)', borderRadius: 24, padding: 32, boxShadow: '0 10px 26px rgba(18,20,30,.06)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', minHeight: 260, height: '100%' }}
            >
