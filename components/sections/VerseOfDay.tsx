  ...
  return (
    <motion.div
      ...
      style={{
        ...
        boxShadow: "0 30px 70px rgba(45,66,201,.28)",
        textAlign: "center",
      }}
    >
      <div style={{ position: "absolute", inset: "-20%", background: "radial-gradient(circle at 75% 20%,rgba(240,116,47,.4),transparent 60%)", pointerEvents: "none", animation: "gradient-drift 14s ease-in-out infinite" }} />
