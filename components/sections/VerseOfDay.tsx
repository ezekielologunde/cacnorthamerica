...
export function VerseOfDay() {
  ...
  return (
    ...
    >
      <div style={{ position: "absolute", inset: "-20%", background: "radial-gradient(circle at 75% 20%,rgba(30,58,138,.4),transparent 60%)", pointerEvents: "none", animation: "gradient-drift 14s ease-in-out infinite" }} />
