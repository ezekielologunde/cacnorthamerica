  ...
  return (
    <motion.div
      ...
      style={{
        ...
        boxShadow: "0 30px 70px rgba(30,58,107,.28)",
        textAlign: "center",
      }}
    >
      <div style={{ position: "absolute", inset: "-20%", background: "radial-gradient(circle at 75% 20%,rgba(61,95,161,.4),transparent 60%)", pointerEvents: "none", animation: "gradient-drift 14s ease-in-out infinite" }} />
