      ...
      <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
        ...
        <input
          ...
          style={{
            ...
            border: "1px solid rgba(245,246,250,.15)",
            borderRadius: 10,
            fontSize: 14,
            color: "#fff",
            fontFamily: "inherit",
          ...
          onFocus={(e) => { e.currentTarget.style.borderColor = "rgba(245,246,250,.4)"; }}
          onBlur={(e) => { e.currentTarget.style.borderColor = "rgba(245,246,250,.15)"; }}
        />
        <SubmitButton />
      </div>
      {state && !state.ok && (
